...
USE_CASE_MODELS = {
    "coding": {
        ...
        "ollama": "ollama/qwen3-coder-next:cloud",
    ...
    "complex_reasoning": {
        "custom_codex": "custom_codex/codex",
        "ollama": "ollama/deepseek-v4-flash:cloud",
...
MODEL_ALIASES: dict[str, str] = {
    ...
    "ministral-3b": "ollama/ministral-3:3b-cloud",
    "qwen-coder": "ollama/qwen3-coder-next:cloud",
    "qwen3-coder": "ollama/qwen3-coder-next:cloud",
    "deepseek-flash": "ollama/deepseek-v4-flash:cloud",
    "deepseek-v4": "ollama/deepseek-v4-flash:cloud",
...
def get_model_info(model: str) -> dict:
    ...
    info_map = {
        ...
        "deepseek-v4-flash": {"name": "DeepSeek v4 Flash", "use": "Reasoning", "provider": "Ollama"},
        "qwen3.5": {"name": "Qwen 3.5", "use": "General", "provider": "Ollama"},
        "ministral-3": {"name": "Ministral 3B", "use": "Fast Response", "provider": "Ollama"},
